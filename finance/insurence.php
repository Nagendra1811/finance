...
<tr>
<td width=70%>
<div class="cust"> <b> Insurence </b> </div>
<div>
	<br/>
  <form name="insurence" method=post action="printrecipt.php" onsubmit="if( window.check ) { return check(); } return true;">
   <table width=100% border=0 cellspacing=5 cellpadding=5>
   <tr>
	<td width=65%>
       	<?php 
	include "sqlconnect.php";
	$query="Select insurence from report";
...
<td align=right>
<br>
<input type="submit" name="insurence" value="Submit" >  
</td>
<td align=left>
<br>
