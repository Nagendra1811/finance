...
<tr>
<td width=70%>
<div class="cust"> <b> Money Transfer </b> </div>
<div>
	<br/>
  <form name="mt" method=post action="printrecipt.php" onsubmit="if( window.check ) { return check(); } return true;">
   <table width=100% border=0 cellspacing=5 cellpadding=5>
   <tr>
	<td width=65%>
       	<?php 
	include "sqlconnect.php";
	$query="Select mt from report";
...
<td align=right>
<br>
<input type="submit" name="mt" value="Submit" >  
</td>
<td align=left>
<br>
